				...
				<div class="container">
					<div class="page-breadcrumb-content text-center">
						<div class="page-breadcrumb-title">
							<h2 class="breadcrumb-head black bold">Sorting Algorithm <span>Course Details.</span></h2>
						</div>
					...
					<div class="row">
						<div class="col-md-9">
							<div class="course-details-item">
								<div class="course-single-pic mb30" style={{ display: "flex", justifyContent: "center" }}>
